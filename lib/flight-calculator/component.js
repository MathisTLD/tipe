...
class Calculation {
  ...
  static normalizeOptions(opts = {}) {
    const options = {
      ...
      algorithm: "dijkstra", // dijkstra or a*
      precision: 400,
      directions: 2,
      weather: true,
    ...
    safeAssign(["weather", "aircraft", "algorithm"]); // TODO: add type check / validation
    return options;
  }
...
module.exports = {
  ...
  methods: {
    ...
    parseAircraft(file) {
      // FIXME: fuelFlow values are sometimes 10^9 times to big
