    ...
    this.primitives = {
      segments: new CustomPrimitive({
        ...
        vertexShaderSource: new Cesium.ShaderSource({
          sources: [require("raw-loader!./glsl/segmentDraw.vert").default] // this is a string containing source code
        }),
        fragmentShaderSource: new Cesium.ShaderSource({
          sources: [require("raw-loader!./glsl/segmentDraw.frag").default]
        }),
      ...
      trails: new CustomPrimitive({
        ...
        vertexShaderSource: new Cesium.ShaderSource({
          ...
          sources: [require("raw-loader!./glsl/fullscreen.vert").default]
        }),
        fragmentShaderSource: new Cesium.ShaderSource({
          defines: ["DISABLE_LOG_DEPTH_FRAGMENT_WRITE"],
          sources: [require("raw-loader!./glsl/trailDraw.frag").default]
        }),
        rawRenderState: Util.createRawRenderState({
          viewport: undefined,
          depthTest: {
      ...
      screen: new CustomPrimitive({
        ...
        fragmentShaderSource: new Cesium.ShaderSource({
          defines: ["DISABLE_LOG_DEPTH_FRAGMENT_WRITE"],
          sources: [require("raw-loader!./glsl/screenDraw.frag").default]
        }),
        rawRenderState: Util.createRawRenderState({
          viewport: undefined,
          depthTest: {
